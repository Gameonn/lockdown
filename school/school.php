  ...
  <body>
    ...
    <div class="content-wrapper">               
        ...
        <section class="content-header">
          <h1>
           School Details
		   <a href="edit_school.php"> <i class="fa fa-edit"> </i> </a>
          </h1>
          <ol class="breadcrumb">
                  ...
                  <table class="table table-hover">
                   <!-- <tr>
					 ...
					 <?php } ?>
					  ...
					  <td> <?php
					  if($res[0]['authority_numbers']){
					   echo $res[0]['authority_numbers'];
					   }else{
	...
	<div class="row mtb">
		  <div style="  font-size: 18px;font-family: sans-serif; font-weight: 400;letter-spacing: 1px;  padding-top: 10px;"> Administrator Details </div>
                <table class="table table-hover">
					<tr>
                      <td class="lead">Administrator Email</td>
                      <td><?php echo $res[0]['principal_email']; ?></td>
					  </tr>
					  <tr>
                      <td class="lead">Administrator Contact</td>
					  <td> <?php echo ($res[0]['principal_phone']?$res[0]['principal_phone']:"No Number Added"); ?> </td>
                    </tr>            
                  </table>
		</div>
		...
		<div class="row ">
		  <div style="font-size: 18px;font-family: sans-serif; font-weight: 400;letter-spacing: 1px;  padding-top: 10px;"> Local Police Details </div>
		        ...
		        <table class="table table-hover">
                      ...
                      <td> <?php
					  if($res[0]['police_email']){
					   echo $res[0]['police_email'];
					   }else{
					   echo "No Email Added";
					   }
					    ?> </td>
					  ...
					  <td> <?php
					  if($res[0]['police_contact']){
					   echo $res[0]['police_contact'];
					   }else{
					   echo "No Number Added";
					   }
					    ?> </td>

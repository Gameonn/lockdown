            ...
            <?php } // --./ error -- ?>
              ...
              <div class="box box-danger">
                 <div class="box-header">
                  ...
                  <span style="  padding-left: 25px; color: #ccc;"> Double Click on Image </span>
                </div>   <!-- /.box-header -->
                <div class="box-body no-padding">
                  <ul class="users-list clearfix col-md-12 random">
                    ...
                    <?php
                    if(!count($res)){
                    echo "<br><br><h4 style='text-align:center;'>No Pictures Clicked in this Lockdown</h4><br><br>";
                    }
                    else{
                   ...
                   <li  class="col-md-3">
                     <div >
                     <div class="photo">
                     <a href="../uploads/<?php echo $subarray['pic'];?>" class="fancybox">

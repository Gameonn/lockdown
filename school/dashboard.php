...
$sql="select count(users.id) as cs, (select count(users.id) from users where user_type='warden' and users.school_id=:sid) as wc from users where user_type='staff' and users.school_id=:sid";
              ...
              <div class="info-box">
                ...
                <div class="info-box-content">
                 <span class="info-box-number"> <?php echo $res[0]['wc']; ?></span>
                  <span class="info-box-text"><h4>Warden</h4></span>

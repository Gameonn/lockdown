...
$sth=$conn->prepare("select * from school");
try{$sth->execute();}
catch(Exception $e){}
$res=$sth->fetchAll();
?>
 ...
 <!DOCTYPE html>
  ...
  border-bottom:1px solid #CFC7C7;
    ...
    <meta charset="UTF-8">
    <title>Lockdown| Add School Admin</title>
    ...
    <div class="content-wrapper">               
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-user"></i> Add School Admin </a></li>
        ...
        <div class="" style="margin-top:20px;">
			<h4 class="control-label">Select School</h4>
          ...
          <div class="form-group" style="margin-top:20px;">
           ...
           <div class="col-sm-10 col-sm-offset-2 submit-btn-con" style="margin-top:20px;">
            ...
            Save Changes</button>
              ...
              <!-- hidden -->
              <input type="hidden" name="event" value="add-school-admin">

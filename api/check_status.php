<?php
//this is an api to check lockdown status
...
if(!($access_token && $lockdown_id)){
	...
	$uname= DataClass::get_lockdown_name($school_id,$lockdown_id)? DataClass::get_lockdown_name($school_id,$lockdown_id):[];
...
$uname=$uname?$uname:"";
$user_mode=$user_mode?$user_mode:"";

// +-----------------------------------+
// + STEP 4: send json data			   +
// +-----------------------------------+
//if($success==1)
echo json_encode(array("success"=>$success,"msg"=>$msg, "data"=>$data,"uname"=>$uname,"user_mode"=>$user_mode));
//else
